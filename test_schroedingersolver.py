...
def test_V1():
    ...
    result = (np.loadtxt("wavefunctions.dat"),
              np.loadtxt("potential.dat"),
              np.loadtxt("energies.dat"),
              np.loadtxt("expvalues.dat"))
    testdata = (np.loadtxt(os.path.join(datalocation,"wavefunctions.dat")),
                np.loadtxt(os.path.join(datalocation,"potential.dat")),
                np.loadtxt(os.path.join(datalocation,"energies.dat")),
                np.loadtxt(os.path.join(datalocation,"expvalues.dat")))
